...
For Sales Reps: A streamlined, mobile-optimized interface to record shop visits, sales, and inventory updates in seconds.

For Management: A powerful analytics dashboard featuring real-time revenue tracking, route performance maps, and product trend analysis.
...
(Add screenshots of your project here after uploading)
